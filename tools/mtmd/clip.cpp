...
struct clip_graph {
    ...
    ggml_cgraph * build_qwen2vl() {
        ...
        if (use_window_attn) {
            ...
            // window_mask = ggml_new_tensor_2d(ctx0, GGML_TYPE_F32, n_pos, n_pos); // for non-FA
...
private:
    ...
    ggml_tensor * build_attn(
        ...
        constexpr bool use_flash_attn = true;
        ...
        case PROJECTOR_TYPE_QWEN25VL:
            {
                ...
                if (use_window_attn) {
                    ...
                    // std::vector<float> mask(pow(ipw * iph, 2), std::numeric_limits<float>::lowest()); // for non-FA
                    ...
                    for (int y = 0; y < ph; y += grid_window) {
                        for (int x = 0; x < pw; x += grid_window) {
                            ...
                            for (int r=0; r < win_h * win_w * merge_ratio * merge_ratio; r++) {
                                ...
                                // int row_offset = mask_row * n_vis_tokens; // for non-FA
                                std::fill(
                    ...
                    // set_input_f32("window_mask",    mask); // for non-FA
